...
# ====================================== #
echo "Running AI service database migrations..."
/opt/venv/bin/alembic -c /nveil/backend/ai_service/database/alembic.ini upgrade head

/opt/venv/bin/python3 -B -m uvicorn ai_server:ai_app --host 0.0.0.0 --port 8100 \
